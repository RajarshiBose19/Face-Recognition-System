...
def adduser(sheet_name):
    ...
    name = tk.Label(frame, text="Enter name of Candidate",font=heading_font, bg="#f2f2f2")
    name.pack(pady=20)
    ...
    roll = tk.Label(frame, text="Enter Id no",font=heading_font, bg="#f2f2f2")
    roll.pack()
...
def attendance(sheet_name):
    ...
    name = "xddd"
    roll = ""
    dataframe = openpyxl.load_workbook("face.xlsx")
...
def takephoto(name,roll,sheet_name):
    workb = openpyxl.load_workbook("face.xlsx")
...
def createnewhseet(name):
    print(name)
    workbook = openpyxl.load_workbook("face.xlsx")
...
def home():
  ...
  btn = tk.Button(root, text="Recognition", fg="red", command=lambda: listsheets('attendence'), width=19, height=2)
...
def admin():
    ...
    heading_label = tk.Label(root, text="Facial Recognition System Using AI", font=heading_font, bg="#f2f2f2")
